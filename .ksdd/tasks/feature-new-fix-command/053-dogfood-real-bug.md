...
## Fora de escopo
- QA sistemática de todos os modos (task 054).
...
- Se a task 051 corrigir a contagem antes, o dogfood precisa de outro bug real — manter uma lista curta de candidatos.
